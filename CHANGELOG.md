...
## 🔥 Key Highlights
*   **Performance Rewrite:** The core hardware interaction logic (`x3d-apply`) has been replaced by a compiled C binary (`x3d-toggle`). This eliminates shell interpretation overhead for critical hardware state changes.
